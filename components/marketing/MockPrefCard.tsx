...
export function MockPrefCard() {
  return (
    <div className="rounded-2xl border border-[#1a2332] bg-[#080b10] p-6 shadow-2xl shadow-black/40 max-w-sm mx-auto">
      <div className="text-xs uppercase tracking-wide text-white/40 mb-3">
        ← Surgeons
      </div>

      <div className="flex items-center gap-3 mb-6">
        <div className="w-12 h-12 rounded-full bg-[#052e16] text-[#4ade80] flex items-center justify-center font-semibold text-sm">
          AP
        </div>
      ...
      <div className="flex items-center gap-3 mb-4">
        <div className="w-10 h-10 rounded-md bg-[#1a2332] flex items-center justify-center text-xl">
          🦵
        </div>
        <div>
      ...
      <div className="rounded-md border border-[#fb923c]/30 bg-[#1c0a00] p-3 mb-4">
        <p className="text-[10px] uppercase tracking-wide text-[#fb923c] mb-1">
          Flags
        </p>
        <p className="text-xs text-[#fb923c]">Confirm graft size before incision</p>
      </div>

      <div className="flex border-b border-[#1a2332] mb-4">
        <span className="flex-1 text-xs font-medium border-b-2 border-[#4ade80] text-[#4ade80] py-2 text-center -mb-px">
          Implants
        </span>
      ...
      <div className="space-y-4">
        <section>
          ...
          <div className="rounded-md border border-[#1a2332] bg-[#0d1117] p-3">
